...
public:
    ...
    // Getter and Setters
    std::vector<Stretch> * getStretchVecPtr(bool isForward);
    ...
    // Methods
    void buildStretches(std::string *chromosome);
    void buildElements(std::string *chromosome);
    void findRTs();
    void writeFeatureMatrix(std::string filePath, std::string *chromosome, std::string *otherChromosome);
    void writeStretches(std::string forwardFilePath, std::string backwardFilePath);
