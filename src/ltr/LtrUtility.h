...
public:
    ...
    */
    ...
    static void collectFastaFiles(std::vector<std::string> &collectVec, std::string &directory);

    static void collectFastaFiles(std::vector<std::string> &collectVec, std::vector<std::string> &directoryVec);

    static void collectBedFiles(std::vector<std::string> &collectVec, std::string &directory);

    static void collectBedFiles(std::vector<std::string> &collectVec, std::vector<std::string> &directoryVec);

    static std::unique_ptr<IdentityCalculator<int32_t>> buildCalculator(double threshold, std::string dbPath, int coreCount, bool skip);
