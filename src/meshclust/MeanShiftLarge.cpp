...
//template<class V>
//void MeanShiftLarge<V>::clusterReservoirOld() {
...
//				int size = block->size();
//				seqNum += size;
//				if (size >= blockSize / 2.0) {
//					ms->updateReferenceData(block);
//				} else {
//					// This was the last block
//					auto t = identity.unpackBlock(block, threadNum);
//					reservoir.add(
//							std::make_tuple(get < 0 > (t), get < 1 > (t),
//									get < 2 > (t), get < 3 > (t), size));
//					isReading = false;
//					printStatus();
//				}
//			}
...
//
//	ms->removeSingles();
//	// Make sure no clusters can be merged further
//	int o = -1;
//	int n = ms->getClusterList()->size();
//	while (o != n) {
//		ms->mergeGreedy();
//		o = n;
//		n = ms->getClusterList()->size();
//	}
//	printStatus(true);
//
//	// Assign data
...
//
//template<class V>
//void MeanShiftLarge<V>::clusterReservoirSlow() {
//	std::cout << std::endl << "Clustering ... " << std::endl;
//	FastaReader reader(dbFile, blockSize);
//	auto block = reader.read();
//	seqNum += block->size();
