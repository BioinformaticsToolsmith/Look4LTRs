...
public:
	...
	// template <typename V>
	// static IdentityCalculator<V> *makeInstance(DataGenerator *g, int threadNum, double t, bool skip, bool relax, std::string modelFile);
	 ...
	 */
	double score(std::string *seq1, std::string *seq2);
